...
import { BrandHeader, BottomNav, ScreenTopBar } from './components/UI.jsx';
...
export default function App() {
  ...
  const activeTab = primary ? view : 'more';
  ...
  return <div className="app-frame">
    <div className="brand-arc brand-arc-left" aria-hidden="true" /><div className="brand-arc brand-arc-right" aria-hidden="true" />
    <div className="app-shell">
      {view === 'home' ? <BrandHeader /> : <ScreenTopBar onBack={() => navigate(primary ? 'home' : 'more')} onHome={() => navigate('home')} />}
      <main className="screen" id="main-content">{screens[view] || screens.home}</main>
